...
public class MessageReceivingApplicationMDP {
	...
	public static void main(String[] args) throws JMSException {
		...
		// this time going to use a Message Driven POJO i.e. a class with a callback method - this is the correct way to do this!
		...
		// so callback would be in a separate microservice
